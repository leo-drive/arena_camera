...
public:
  explicit CameraSetting(const std::string &camera_name,
                         ...
                         bool resize_image, const std::string &url_camera_info)
      : m_camera_name{camera_name}, m_frame_id{frame_id},
        m_pixel_format{pixel_format}, m_serial_no{serial_no}, m_fps{fps},
        m_horizontal_binning{horizontal_binning}, m_vertical_binning{vertical_binning}, m_resize_image{resize_image}, m_url_camera_info{url_camera_info} {
